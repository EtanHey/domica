import { pgTable, uuid, varchar, text, decimal, integer, boolean, timestamp, date, jsonb, index, primaryKey } from 'drizzle-orm/pg-core';
...
export const rentalAmenities = pgTable('rental_amenities', {
  rentalId: uuid('rental_id').notNull().references(() => rentals.id, { onDelete: 'cascade' }),
