...
class FacebookPostExtractorV2 {
  ...
  isRentalOffer(text) {
    ...
    const seekingKeywords = [
      ...
      'רוצה', 'רוצים', 'רוצות',
      'זקוק', 'זקוקה', 'זקוקים',
      'חייל בודד', 'סטודנט מחפש', 'סטודנטית מחפשת',
    ...
    const offerKeywords = [
      'להשכרה', 'להשכיר', 'משכיר', 'משכירה', 'משכירים',
      'פנויה', 'פנוי', 'פנויים', 'מושכרת',
      'כניסה מיידית', 'כניסה ב', 'כניסה החל מ',
      'לתקופה ארוכה', 'לתקופה קצרה'
    ];
